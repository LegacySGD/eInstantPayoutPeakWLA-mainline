...
public class PayoutPeakWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(PayoutPeakWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/PayoutPeakWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/PayoutPeakWLAIW/InitOutcome.xml").getDocumentElement();
